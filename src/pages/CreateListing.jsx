  ...
  return (
    <main className="max-w-md px-2 mx-auto">
      ...
      <form>
        ...
        <div className="flex space-x-6 mb-6">
          <div>
            ...
            <input
              ...
              max="50"
              required
              className="w-full x-4 py-2 text-xl text-gray-700 bg-white border-gray-300 rounded transition duration-150 ease-in-out
        ...
        <p className="text-lg mt-6 font-semibold">Fully Furnished</p>
        <div className="flex ">
          <button
            type="button"
            id="furnished"
            ...
            <div className="flex w-full justify-center items-center space-x-6">
              <input
                ...
                className="w-full px-4 py-2 text-xl text-gray-700 bg-white border-gray-300
                                 ...
                                 focus:border-slate-600 text-center mr-1"
              />
              {type === "rent" && (
                <div className="">
                  <p className="text-md w-full whitespace-nowrap ml-1">
                    {" "}
                    AED / Month
                  </p>
                </div>
        ...
        font-medium text-sm uppercase rounded shadow-md hover:bg-blue-700 focus:bg-blue-700
        hover:shadow-lg focus:shadow-lg active:bg-blue-800 active:shadow-lg
